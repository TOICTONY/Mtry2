...
LEECH_FILENAME_METADATA = environ.get('LEECH_FILENAME_METADATA', '')
if len(LEECH_FILENAME_METADATA) == 0:
    LEECH_FILENAME_METADATA = ''
...
MIRROR_FILENAME_METADATA = environ.get('MIRROR_FILENAME_METADATA', '')
if len(MIRROR_FILENAME_METADATA) == 0:
    MIRROR_FILENAME_METADATA = ''
...
config_dict = {'ANIME_TEMPLATE': ANIME_TEMPLATE,
               ...
               'LEECH_FILENAME_METADATA': LEECH_FILENAME_METADATA,
               ...
               'MIRROR_FILENAME_METADATA': MIRROR_FILENAME_METADATA,
