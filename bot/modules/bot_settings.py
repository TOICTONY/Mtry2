...
async def load_config():
    ...
    LEECH_FILENAME_METADATA_EDIT = environ.get('LEECH_FILENAME_METADATA_EDIT', '')
    ...
    MIRROR_FILENAME_METADATA_EDIT = environ.get('MIRROR_FILENAME_METADATA_EDIT', '')
...
<a href='{url}'>Read More ...</a>'''
    ...
    config_dict.update({'ANIME_TEMPLATE': DEF_ANI_TEMP,
                        ...
                        'LEECH_FILENAME_METADATA_EDIT': LEECH_FILENAME_METADATA_EDIT,
                        ...
                        'MIRROR_FILENAME_METADATA_EDIT': MIRROR_FILENAME_METADATA_EDIT,
